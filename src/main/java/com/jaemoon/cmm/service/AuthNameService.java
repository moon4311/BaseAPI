...
import com.jaemoon.cmm.mapper.AuthNameMapper;

import lombok.RequiredArgsConstructor;

@Service
@RequiredArgsConstructor
public class AuthNameService extends ServiceParent  implements BaseServiceIf{

	private final AuthNameMapper mapper;

	private final static String PK = "authId";
