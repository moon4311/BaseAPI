...
import com.jaemoon.cmm.mapper.AuthGrantMapper;

import lombok.RequiredArgsConstructor;

@Service
@RequiredArgsConstructor
public class AuthGrantService extends ServiceParent  implements BaseServiceIf{

	private final AuthGrantMapper mapper;

	private final static String PK = "authGrantId";
